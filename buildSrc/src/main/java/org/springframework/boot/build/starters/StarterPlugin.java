...
public class StarterPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        project.getArtifacts().add("starterMetadata", project.provider(starterMetadata::getDestination), (artifact) -> artifact.builtBy(starterMetadata));
    ...
    private void createClasspathConflictsCheck(Configuration classpath, Project project) {
        CheckClasspathForConflicts checkClasspathForConflicts = project.getTasks().create("check" + StringUtils.capitalize(classpath.getName() + "ForConflicts"), CheckClasspathForConflicts.class);
    ...
    private void createProhibitedDependenciesCheck(Configuration classpath, Project project) {
        CheckClasspathForProhibitedDependencies checkClasspathForProhibitedDependencies = project.getTasks().create("check" + StringUtils.capitalize(classpath.getName() + "ForProhibitedDependencies"), CheckClasspathForProhibitedDependencies.class);
